...
def attack(char_name: str, char_class: str) -> str:
    """Determine the amount of damage inflicted on the enemy."""
...
def defence(char_name: str, char_class: str) -> str:
    """Determine the result of blocking a blow."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Start training for a character by user inputs."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Select the character class by user input."""
    approve_choice: str = ''
    char_class: str = ''
